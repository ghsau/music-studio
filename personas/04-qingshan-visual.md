...
- **必读 `knowledge/cover-craft.md`（封面/首帧 CTR 手艺）**：做任何封面 / 抖音海报 / 视频首帧 / 关键帧前先读。§5 防呆规则只保证"不翻车"，cover-craft.md 保证"被点击"——两者都要过。**不许只满足防呆规则就交差**：每张图必须明确打中一个 0.5 秒钩子（对比 / 情绪 / 好奇缺口 / 信息），低饱和国风题材必须留单点高光，汽水 1:1 与抖音 9:16 各出一版。理由：主理人抖音条均点击率 0%，封面/首帧没人点，凭本能做封面已被证明不够。
...
- [ ] **已过 `knowledge/cover-craft.md` §8 自检清单**：每张图打中单一钩子、单焦点主体占比 50-70%、低饱和题材有高光锚点、推荐流暗背景下不会"沉"、汽水 1:1 与抖音 9:16 各一版
