...
> **铁律 · 每轮回复前必做**：回应主理人当前消息**之前**，先扫一遍所有在手 task——任何一首有可派的活（决策点已过、或有能独立推进的 chunk）且当前没有 subagent 在跑 → **立刻派后台 subagent**。主理人**永远不该需要催你起 subagent**——派活是 orchestrator 的主动职责，不是被动响应。扫完派完，再回应主理人当前的话。不许因为主理人正深聊某一首，就让别的歌晾着。
